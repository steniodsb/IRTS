...
export default async function AdminComunidadePage() {
  ...
  const [{ data: threads }, { count: catCount }, { count: postCount }] = await Promise.all([
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        <Card><p className="text-3xl font-semibold text-cream">{catCount ?? 0}</p><p className="mt-1 text-sm text-cream/50">Categorias</p></Card>
